    ...
    switch (input_type) {
        case 'f':
            _inquirer2.default.prompt([_questions2.default.input_file_name, _questions2.default.output_file_name]).then(function (_ref2) {
                ...
                _fs2.default.existsSync(input_file_name, function (exists) {
                    if (exists) {
            ...
            break;
        case 'd':
            _inquirer2.default.prompt([_questions2.default.dir_path]).then(function (_ref3) {
                var dir_path = _ref3.dir_path;

                try {
                    if (_FileUtils2.default.isDirectory(dir_path)) {
                        console.log(_fs2.default.readdirSync(dir_path));
                    }
                } catch (err) {
